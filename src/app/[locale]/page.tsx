      ...
      <main className="bg-navy-deep text-ivory">
        ...
        <section className="relative isolate min-h-[100svh] overflow-hidden">
          ...
          <div className="container-page relative z-[2] flex min-h-[100svh] flex-col justify-end pb-24 pt-32 sm:pb-28">
            <h1 className="display max-w-4xl text-[2.6rem] leading-[1.02] sm:text-[4rem] lg:text-[5.4rem]">
              {t("heroTitle")}
            </h1>
            <p className="serif mt-6 text-[1.15rem] italic text-ivory/85 sm:text-[1.35rem]">{t("heroLine", { date: openingDate })}</p>
                ...
                return (
                  <li key={c.key} className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
                    ...
                    <Reveal delay={150} className={`${flip ? "lg:col-span-5 lg:col-start-1 lg:order-1" : "lg:col-span-5 lg:col-start-8"}`}>
                      <h2 className="display text-[2.2rem] sm:text-[3rem]">{t(`chapters.${c.key}.title`)}</h2>
        ...
        <section className="relative grain overflow-hidden bg-navy-deep py-20 sm:py-28">
          <div className="container-page">
            <Reveal className="max-w-2xl">
              <h2 className="display text-[2rem] sm:text-[2.8rem]">{t("roadTitle")}</h2>
        ...
        <section className="relative isolate min-h-[80svh] overflow-hidden">
          ...
          <div className="container-page relative z-[2] flex min-h-[80svh] flex-col justify-center py-24">
            <Reveal className="max-w-xl">
              <h2 className="display text-[2rem] sm:text-[2.8rem]">{t("craftTitle")}</h2>
        ...
        <section className="bg-navy py-20 sm:py-28">
          <div className="container-page grid gap-12 lg:grid-cols-12 lg:items-center">
            <Reveal className="lg:col-span-4">
              <h2 className="display text-[2rem] sm:text-[2.6rem]">{t("roomTitle")}</h2>
        ...
        <section className="relative grain overflow-hidden bg-navy-deep py-20 sm:py-28">
          <div className="container-page grid gap-12 lg:grid-cols-12">
            <Reveal className="lg:col-span-7">
              <h2 className="display text-[2.4rem] sm:text-[3.4rem]">{t("bookTitle")}</h2>
